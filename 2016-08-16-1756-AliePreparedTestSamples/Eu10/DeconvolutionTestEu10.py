...
initdecay = 83
impulse_response = np.average(blue2[initdecay:,:,:],axis=(1,2)) #only blue channel is taken into accoun t for IRF
...
#normalize impulse_response
impulse_response = impulse_response / impulse_response.max()
    
recoveredRed = deconvolve(sred[4:], impulse_response)
recoveredBlue = deconvolve(sblue[4:], impulse_response)
