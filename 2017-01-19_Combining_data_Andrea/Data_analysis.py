...
###############################################################################
###############################################################################
####NOTE THAT THE 1D SHOULD ALREADY BE ONLY THE DECAY!!!!!!!!!!!    
...
prefixend = pref0 + pref1 + pref2 + pref3 
print(prefixend)
...
for index in listofindex: 
    ...
    print('bef loading')
    redd = np.load(loadprefix + 'varCprevtautriple' + let[index] + 'RED1D.npz',mmap_mode='r') #any prefix will do
    blued = np.load(loadprefix +'varCprevtautriple' + let[index] + 'BLUE1D.npz',mmap_mode='r') #any prefix will do
    red = redd['data']
    blue = blued['data']
