...
namese = ['2016-10-20-0838_ImageSequence_ND+Au140_22.802kX_10.000kV_30mu_4',
          '2016-10-20-0859_ImageSequence_ND+Au100_22.800kX_10.000kV_30mu_11',
          '2016-10-20-0907_ImageSequence_ND+Au40_22.800kX_10.000kV_30mu_2',
          '2016-10-20-0907_ImageSequence_ND+Au40_22.800kX_10.000kV_30mu_2']
                  
nametr = ['2016-10-20-0843_ImageSequence_ND+Au140_22.802kX_10.000kV_30mu_5',
          '2016-10-20-0903_ImageSequence_ND+Au100_22.800kX_10.000kV_30mu_12',
          '2016-10-20-0911_ImageSequence_ND+Au40_22.800kX_10.000kV_30mu_3',
          '2016-10-20-0931_ImageSequence_ND+Au40_22.800kX_10.000kV_30mu_4']
              
         
No_experiments = [10,10,10,50]

description = ['Adamas NDs'] # (20kV, 30$\mu$m, ' + str(Ps[index]) + 'nm pixels, ' + str(No_experiments[index]) + 'expts., InLens registered)'] #, \n' #+ obs[index] ']    
               
kv = [10]

let = ['A140','B100','C40','C40II']
...
#for index in np.arange(0,len(nametr)):
    ...
    se1_dsetold = np.array(se1_dset) #, dtype=np.float16) #convert to 16 if needed
    hel = np.reshape(se1_dsetold, (512,512))
    se1_dset2 = scipy.misc.imresize(hel, (250,250), interp='bilinear', mode=None)
    se1_dset2 = np.reshape(se1_dset2,(1,250,250))
...
index = 3
if index is 3:
#for index in np.arange(0,2):# listofindex:
...
#        datablue = datablue[initbin:,:,:]
    ...
    fastfactor = 1
    last_pt_offset = -80 #sometimes use -1, last point, but sometimes this gives 0. -10 seems to work
    medium_pt_offset = -40
