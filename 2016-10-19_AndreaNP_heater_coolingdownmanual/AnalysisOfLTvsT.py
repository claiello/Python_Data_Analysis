...
nametr = ['2016-10-19-0827_ImageSequence_Andrea_10.000kX_10.000kV_30mu_4',
          '2016-10-19-0833_ImageSequence_Andrea_10.000kX_10.000kV_30mu_6',
          '2016-10-19-0838_ImageSequence_Andrea_10.000kX_10.000kV_30mu_8',
          '2016-10-19-0844_ImageSequence_Andrea_10.000kX_10.000kV_30mu_10',
          '2016-10-19-0849_ImageSequence_Andrea_10.000kX_10.000kV_30mu_12',
          '2016-10-19-0855_ImageSequence_Andrea_10.000kX_10.000kV_30mu_14']
namese = ['2016-10-19-0828_ImageSequence_Andrea_10.000kX_10.000kV_30mu_5',
          '2016-10-19-0834_ImageSequence_Andrea_10.000kX_10.000kV_30mu_7',
          '2016-10-19-0839_ImageSequence_Andrea_10.000kX_10.000kV_30mu_9',
          '2016-10-19-0845_ImageSequence_Andrea_10.000kX_10.000kV_30mu_11',
          '2016-10-19-0850_ImageSequence_Andrea_10.000kX_10.000kV_30mu_13',
          '2016-10-19-0856_ImageSequence_Andrea_10.000kX_10.000kV_30mu_15'] 
...
#    red1_dset_reg = np.array(new, dtype=np.float32)
    ...
    del se1_dset, red1_dset, il1_dset, blue1_dset
    file1.close()
    file2.close()
    gc.collect()
...
cumu_blue = np.zeros([6,10])
cumu_red = np.zeros([6,10])
il_data = np.zeros([6,10])

listofindex =np.arange(0,6) # #[0,1,2]  [5] 
#index = 1
#if index is 0:
...
#    
    ...
    if index == 0: #needs to be reworked out
       #pass
       #init_guess = [9.0, 0.02, 2.0, 2.5,5.0 ] #RED
       
       #init_guess2 = [78.0, 0.03, 5.0, 7.6,7.0 ] #BLUE
       
       init_guess = [9.0, 0.02, np.nanmean(hlp_red[last_pt_offset:,:,:]), 0.25, 0.2 ] #RED
              
       init_guess2 = [78.0, 0.03, np.nanmean(hlp_blue[last_pt_offset:,:,:]), 0.76, 1.0 ] #BLUE
          
    if index == 1:
        #init_guess = [20.0, 0.01, 0.5,8.5, 10.0 ] #RED
        #init_guess2 = [62.8, 0.03,0.5,23.0, 5.8 ] #BLUE
     
        
        
        init_guess = [12.0, 0.05, np.nanmean(hlp_red[last_pt_offset:,:,:]), 5.5, 1.0 ] #RED
        init_guess2 = [6.8, 0.03,np.nanmean(hlp_blue[last_pt_offset:,:,:]), 1.30, 1.58 ] #BLUE
    ...
    if index == 2:
        #init_guess = [40.0, 0.05, 0.5, 16.0, 20.0 ] #RED
        #init_guess2 = [80.0, 0.03, 0.5,40.0, 20.0 ] #BLUE
        
        init_guess = [20.0, 0.05, np.nanmean(hlp_red[last_pt_offset:,:,:]), 5.5, 1.0 ] #RED
        init_guess2 = [20.0, 0.03, np.nanmean(hlp_blue[last_pt_offset:,:,:]),1.3, 1.0 ] #BLUE
        
    if index == 3:
        #init_guess = [12.0, 0.03, 0.5, 6.1, 4.0 ] #RED
        #init_guess2 = [97.0,0.04, 0.5,13.0, 4.0]#BLUE
        
        init_guess = [12.0, 0.03, np.nanmean(hlp_red[last_pt_offset:,:,:]), 6.1, 1.0 ] #RED
        init_guess2 = [97.0,0.04,np.nanmean(hlp_blue[last_pt_offset:,:,:]),1.0, 1.0]#BLUE
    if index == 4:
        #init_guess = [30.0, 0.05, 0.5, 18.0, 10.0 ] #RED
        #init_guess2 = [102.0,0.044, 0.5,48.0, 10.0 ] #BLUE
        
        init_guess = [10.0, 0.05, np.nanmean(hlp_red[last_pt_offset:,:,:]), 6.0, 1.0 ] #RED
        init_guess2 = [102.0,0.044, np.nanmean(hlp_blue[last_pt_offset:,:,:]),1.0, 1.0 ] #BLUE
    if index == 5:
        #init_guess = [30.0,0.05, 10.0,12.0, 5.0 ]
        #init_guess2 = [100.0,0.05, 20.0,30.0, 5.0 ]
        
        init_guess = [30.0,0.05, np.nanmean(hlp_red[last_pt_offset:,:,:]),6.0, 1.0 ]
        init_guess2 = [100.0,0.05, np.nanmean(hlp_blue[last_pt_offset:,:,:]),1.0, 1.0 ]
