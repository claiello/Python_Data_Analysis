...
listofindex =np.arange(0,3)#,11]

consider_whole_light = [1,2]
...
for index in listofindex:
    ...
    titulo = description + let[index] + ' (10kV, 30$\mu$m aperture, 2$\mu$s time bins, ' + str(Ps)+ 'nm pixels, blue/red: $</>$ 593nm)'
    ...
    if True is False:
        ...
        initbin = (95+7)-1 +1 #init bin for decay
        backgdinit = 1
        ### 700ns /40ns = 7. ....
