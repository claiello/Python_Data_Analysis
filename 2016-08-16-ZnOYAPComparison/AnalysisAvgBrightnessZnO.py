...
name_str = ['2016-08-16-1431_ImageSequence_ZnO500kX_500.000kX_3.000kV_30mu_1.hdf5']
...
#for index in np.arange(12,12):
    ...
    file1    = h5py.File('2016-08-16-1431_ImageSequence_ZnO500kX_500.000kX_3.000kV_30mu_1.hdf5', 'r')  
...
#    titulo =  'Upconverting NPs (3kV, 30$\mu$m aperture, 40ns time bins, 36kX or 3.1nm pixels)'
    ...
    red1_dset  = file1['/data/Counter channel 2 : PMT blue/PMT blue/data']#50 frames x 200 tr pts x250 x 250 pixels
    ...
    print(np.average(red1_dset))
    print(np.average(red1_dset, axis = (0,1,2)))
