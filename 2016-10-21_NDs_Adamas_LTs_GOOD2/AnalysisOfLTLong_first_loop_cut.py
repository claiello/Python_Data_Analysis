...
namese = ['2016-10-21-0859_ImageSequence_NDs140_15.000kX_10.000kV_30mu_8',
          '2016-10-21-0903_ImageSequence_NDs140_15.000kX_10.000kV_30mu_10',
          '2016-10-21-0906_ImageSequence_NDs140_15.000kX_10.000kV_30mu_12',
          '2016-10-21-0910_ImageSequence_NDs140_15.000kX_10.000kV_30mu_14',
          '2016-10-21-0915_ImageSequence_NDs140_15.000kX_10.000kV_30mu_17',
          '2016-10-21-0936_ImageSequence_NDs100_15.000kX_10.000kV_30mu_9',
          '2016-10-21-0940_ImageSequence_NDs100_15.000kX_10.000kV_30mu_11',
          '2016-10-21-0948_ImageSequence_NDs100_15.000kX_10.000kV_30mu_13',
          '2016-10-21-1001_ImageSequence_NDs100_15.000kX_10.000kV_30mu_15',
          '2016-10-21-1025_ImageSequence_NDs100_15.315kX_10.000kV_30mu_20']
                  
nametr = ['2016-10-21-0901_ImageSequence_NDs140_15.000kX_10.000kV_30mu_9',
          '2016-10-21-0905_ImageSequence_NDs140_15.000kX_10.000kV_30mu_11',
          '2016-10-21-0908_ImageSequence_NDs140_15.000kX_10.000kV_30mu_13',
          '2016-10-21-0912_ImageSequence_NDs140_15.000kX_10.000kV_30mu_15',
          '2016-10-21-0917_ImageSequence_NDs140_15.000kX_10.000kV_30mu_18',
          '2016-10-21-0934_ImageSequence_NDs100_15.000kX_10.000kV_30mu_8',
          '2016-10-21-0945_ImageSequence_NDs100_15.000kX_10.000kV_30mu_12',
          '2016-10-21-0957_ImageSequence_NDs100_15.000kX_10.000kV_30mu_14',
          '2016-10-21-1017_ImageSequence_NDs100_15.315kX_10.000kV_30mu_16',
          '2016-10-21-1042_ImageSequence_NDs100_15.315kX_10.000kV_30mu_21']
                         
No_experiments = [1,1,1,1,1,3,3,6,10,10]
...
pisize = [1.45,1.45,1.45,1.45,1.45,1.45,1.45,1.45,1.45,1.42] #in nm

listofindex =np.arange(0,len(nametr)) # #[0,1,2]  [5]  ###goes until 10
index =99
if index is 9:
#for index in listofindex:
    ...
    ax1.set_title('CL data averaged over time \n and ' + str(No_experiments[index]) + ' experiments',fontsize=fsizepl)
    ...
    plt.plot(np.arange(0,150)*Time_bin/1e3,np.nanmean(red['data']*hlpd,axis = (0,2,3)),c='k',lw=2) #in mus, in MHz
    ...
    #init red intensity
    plt.plot(np.arange(1,No_experiments[index]+1)*nominal_time_on*fastfactor,np.nanmean(dataALLred[:,0:5+7-1,:,:]*hlp,axis=(1,2,3)),c='r', label='',linestyle='None', marker='o',markersize=3) #in mus, in MHz
    plt.plot(np.arange(1,No_experiments[index]+1)*nominal_time_on*fastfactor,np.nanmean(dataALLred[:,0:5+7-1,:,:]*hlp,axis=(0,1,2,3))*np.ones(dataALLred.shape[0]),c='r',  linewidth= lw) #in mus, in MHz


    red_int_array[index] = np.nanmean(dataALLred*hlp,axis=(0,1,2,3))
    cumu_red[index,0:No_experiments[index]] =  np.nanmean(dataALLred*hlp,axis=(1,2,3))
    ...
    sig_to_initred[index] =   np.nanmean(dataALLred*hlp,axis=(0,1,2,3))/np.nanmean(dataALLred[:,0:5+7-1,:,:]*hlp,axis=(0,1,2,3))
    
    del dataALLred, hlpred, hlp, hlpd, datared, datared_init
    gc.collect()
...
ax1.errorbar(x_vec[cut], b_array_red[cut], yerr=be_array_red[cut], fmt='ro',markersize=5)
ax2.errorbar(x_vec[cut], e_array_red[cut], yerr=ee_array_red[cut], fmt='ro', markersize=10)
