...
nametr = ['2016-10-27-1302_ImageSequence_StefanPill_262.495kX_5.000kV_30mu_2']
...
### register
#independently
se1_dset2 = np.array(se1_dset, dtype=np.float64)#) #, dtype=np.float16) #convert to 16 if needed
se_dset_reg, dummy = reg_images(se1_dset2)
print(type(se_dset_reg))
print(se_dset_reg.shape)
...
ax1.set_title('SE registered')
plt.imshow(se_dset_reg)#,cmap='Reds')
