...
#25.7C, absolutely RT, no voltage applied
...
for index in listofindex:
   ...
   #plt.legend()
    ...
    #deltav = 0.2e-03
    il_data[index,:] = 25.7 #KThermocouplerconversion(1.0e-3 + ) #take average per frame
...
mycode = 'RTRed_std_array' +  'ChosenExp' + str(chosenexp) + '= tempfile.NamedTemporaryFile(delete=False)'
exec(mycode)
np.savez('RTRed_std_array'+  'ChosenExp' + str(chosenexp), data = red_std_array)

mycode = 'RTBlue_std_array'  + 'ChosenExp' + str(chosenexp) + '= tempfile.NamedTemporaryFile(delete=False)'
exec(mycode)
np.savez('RTBlue_std_array' +  'ChosenExp' + str(chosenexp), data = blue_std_array)

mycode = 'RTRed_int_array' +  'ChosenExp' + str(chosenexp) + '= tempfile.NamedTemporaryFile(delete=False)'
exec(mycode)
np.savez('RTRed_int_array'+  'ChosenExp' + str(chosenexp), data = red_int_array)

mycode = 'RTBlue_int_array'+  'ChosenExp' + str(chosenexp) + ' = tempfile.NamedTemporaryFile(delete=False)'
exec(mycode)
np.savez('RTBlue_int_array'+  'ChosenExp' + str(chosenexp), data = blue_int_array)

mycode = 'RTCumu_red'+  'ChosenExp' + str(chosenexp) + ' = tempfile.NamedTemporaryFile(delete=False)'
exec(mycode)
np.savez('RTCumu_red'+  'ChosenExp' + str(chosenexp), data = cumu_red)

mycode = 'RTCumu_blue'+  'ChosenExp' + str(chosenexp) + ' = tempfile.NamedTemporaryFile(delete=False)'
exec(mycode)
np.savez('RTCumu_blue'+  'ChosenExp' + str(chosenexp), data = cumu_blue)

#il_data will be [6,5] in shape
mycode = 'RTIl_data'+  'ChosenExp' + str(chosenexp) + ' = tempfile.NamedTemporaryFile(delete=False)'
exec(mycode)
np.savez('RTIl_data'+  'ChosenExp' + str(chosenexp), data = il_data)

mycode = 'RTIl_data_std'+  'ChosenExp' + str(chosenexp) + ' = tempfile.NamedTemporaryFile(delete=False)'
exec(mycode)
np.savez('RTIl_data_std'+  'ChosenExp' + str(chosenexp), data = il_data_std)

mycode = 'RTB_array_red'+  'ChosenExp' + str(chosenexp) + ' = tempfile.NamedTemporaryFile(delete=False)'
exec(mycode)
np.savez('RTB_array_red'+  'ChosenExp' + str(chosenexp), data = b_array_red)

mycode ='RTBe_array_red'+  'ChosenExp' + str(chosenexp) + ' = tempfile.NamedTemporaryFile(delete=False)'
exec(mycode)
np.savez('RTBe_array_red'+  'ChosenExp' + str(chosenexp), data = be_array_red)

mycode = 'RTE_array_red'+  'ChosenExp' + str(chosenexp) + ' = tempfile.NamedTemporaryFile(delete=False)'
exec(mycode)
np.savez('RTE_array_red'+  'ChosenExp' + str(chosenexp), data = e_array_red)

mycode = 'RTEe_array_red'+  'ChosenExp' + str(chosenexp) + ' = tempfile.NamedTemporaryFile(delete=False)'
exec(mycode)
np.savez('RTEe_array_red'+  'ChosenExp' + str(chosenexp), data = ee_array_red)

mycode = 'RTB_array_blue'+  'ChosenExp' + str(chosenexp) + ' = tempfile.NamedTemporaryFile(delete=False)'
exec(mycode)
np.savez('RTB_array_blue'+  'ChosenExp' + str(chosenexp), data = b_array_blue)

mycode ='RTBe_array_blue'+  'ChosenExp' + str(chosenexp) + ' = tempfile.NamedTemporaryFile(delete=False)'
exec(mycode)
np.savez('RTBe_array_blue'+  'ChosenExp' + str(chosenexp), data = be_array_blue)

mycode = 'RTE_array_blue'+  'ChosenExp' + str(chosenexp) + ' = tempfile.NamedTemporaryFile(delete=False)'
exec(mycode)
np.savez('RTE_array_blue'+  'ChosenExp' + str(chosenexp), data = e_array_blue)

mycode = 'RTEe_array_blue'+  'ChosenExp' + str(chosenexp) + ' = tempfile.NamedTemporaryFile(delete=False)'
exec(mycode)
np.savez('RTEe_array_blue'+  'ChosenExp' + str(chosenexp), data = ee_array_blue)
