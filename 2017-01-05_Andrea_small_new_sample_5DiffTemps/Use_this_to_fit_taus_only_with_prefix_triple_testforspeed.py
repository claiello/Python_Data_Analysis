    ...
    if (prefix == 'fixCprevtautriple') or (prefix=='varCprevtautriple'):
            ...
            if index == 1:
                ...
                if index == 2:
                    ...
                    init_guess[6] = g_array_red[1]
                    init_guessb[1] = b_array_blue[1]
                    init_guessb[4] = e_array_blue[1]  
                    init_guessb[6] = g_array_blue[1]
                if index == 4:
                    init_guess[1] = (b_array_red[2]+b_array_red[1])/2.0
                    init_guess[4] = (e_array_red[2]+e_array_red[1])/2.0
                    init_guess[6] = (g_array_red[2]+g_array_red[1])/2.0
                    init_guessb[1] = (b_array_blue[2]+b_array_blue[1])/2.0
                    init_guessb[4] = (e_array_blue[2]+e_array_blue[1])/2.0  
                    init_guessb[6] = (g_array_blue[2]+g_array_blue[1])/2.0
                if index == 5:
                    init_guess[1] = (b_array_red[2]+b_array_red[1]+b_array_red[4])/3.0
                    init_guess[4] = (e_array_red[2]+e_array_red[1]+e_array_red[4])/3.0
                    init_guess[6] = (g_array_red[2]+g_array_red[1]+g_array_red[4])/3.0
                    init_guessb[1] = (b_array_blue[2]+b_array_blue[1]+b_array_blue[4])/3.0
                    init_guessb[4] = (e_array_blue[2]+e_array_blue[1]+e_array_blue[4])/3.0
                    init_guessb[6] = (g_array_blue[2]+g_array_blue[1]+g_array_blue[4])/3.0        
        
  
     ##################################### THIS IS TO GIVE PREV TAU AS INIT
    if (index == 5) and (prefixend == 'varCsametautriple_nodiv'):
        init_guess[1] = (b_array_red[2]+b_array_red[1]+b_array_red[4])/3.0
        init_guess[4] = (e_array_red[2]+e_array_red[1]+e_array_red[4])/3.0
        init_guess[6] = (g_array_red[2]+g_array_red[1]+g_array_red[4])/3.0  
    if (prefixend == 'varCsametautriple') and (index == 2):
        init_guess[1] = (b_array_red[1])
        init_guess[4] = 200.0#(e_array_red[1])
        init_guess[6] = (g_array_red[1])
    if (prefixend == 'varCsametautriple') and (index == 5):
        init_guessb[1] = (b_array_blue[1])#+b_array_blue[2]+b_array_blue[4])/3.0
        init_guessb[4] = (e_array_blue[1])#+e_array_blue[2]+e_array_blue[4])/3.0
        init_guessb[6] = (g_array_blue[1])#+g_array_blue[2]+g_array_blue[4])/3.0  
