...
consider_whole_light = [1,2,4,5]# [0,1,2,3,4,5,6]
...
#        pass
#    if index == 2:
#        init_guess[1] = b_array_red[1]
#        init_guess[4] = e_array_red[1]
#        init_guessb[1] = b_array_blue[1]
#        init_guessb[4] = e_array_blue[1]
#    if index == 4:
#        init_guess[1] = (b_array_red[2] + b_array_red[1])/2
#        init_guess[4] = (e_array_red[2] + e_array_red[1])/2
#        init_guessb[1] = (b_array_blue[2] + b_array_blue[1])/2
#        init_guessb[4] = (e_array_blue[2] + e_array_blue[1])/2
#    if index == 5:
#        init_guess[1] = (b_array_red[4] + b_array_red[2] + b_array_red[1])/3
#        init_guess[4] = (e_array_red[4] + e_array_red[2] + e_array_red[1])/3
#        init_guessb[1] = (b_array_blue[4] + b_array_blue[2] + b_array_blue[1])/3
#        init_guessb[4] = (e_array_blue[4] + e_array_blue[2] + e_array_blue[1])/3
