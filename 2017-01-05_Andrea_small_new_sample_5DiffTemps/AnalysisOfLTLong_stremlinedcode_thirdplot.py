...
ax0 = plt.subplot2grid((3,7), (0,1), colspan=1, rowspan=1)
se = np.load('V0' +'SEchannel.npz',mmap_mode='r') 
xlen = se['data'].shape[0]
ylen = se['data'].shape[1]
delx = 0#+28
...
ax00 = plt.subplot2grid((3,7), (0,2), colspan=1, rowspan=1)
se = np.load('V0pt25' +'SEchannel.npz',mmap_mode='r') 
xlen = se['data'].shape[0]
ylen = se['data'].shape[1]
delx = 0#+28
...
ax0000 = plt.subplot2grid((3,7), (0,4), colspan=1, rowspan=1)
se = np.load('V0pt5b' +'SEchannel.npz',mmap_mode='r')
xlen = se['data'].shape[0]
ylen = se['data'].shape[1] 
delx = 0#+28
...
ax00000 = plt.subplot2grid((3,7), (0,5), colspan=1, rowspan=1)
se = np.load('V0pt75' +'SEchannel.npz',mmap_mode='r') 
xlen = se['data'].shape[0]
ylen = se['data'].shape[1]
delx = 0#+28
...
ax1.errorbar(x_vec, 1.0/ratio2, fmt='ks',markersize=7.5)
ax1.set_ylabel('Green to red \n intensity ratio',fontsize=fsizepl)
