...
#####checked that all curves have a good model error for 3 lines below:
prefix = 'varCsametautriple_nodiv'
#prefix = 'varCsametaudouble_nodiv'
#prefix = 'varCsametaudouble'
...
##### while dont have excat c background, aposentando os fixed c
#prefix = 'fixCsametautriple'
#prefix = 'fixCsametautriple_nodiv'
#prefix = 'fixCsametaudouble'
#prefix = 'fixCsametaudouble_nodiv'
###############################################################################
#### prevtau or sametau: not big difference for double
#aposentados
#prefix = 'varCprevtaudouble'
#prefix = 'varCprevtaudouble_nodiv'
### estou aposentando todos os com prev tau, sob a alegation que todos os dsets tem de ser tratados iduais
#prefix = 'fixCprevtautriple'
#prefix = 'varCprevtautriple'
#prefix = 'varCprevtautriple_nodiv'
#prefix = 'fixCprevtaudouble_nodiv'
#prefix = 'fixCprevtautriple_nodiv'
#prefix = 'fixCprevtaudouble'
...
try:
    G_array_red2 = np.load('../2016-12-19_Andrea_BigNPs_5DiffTemps/' + prefix +'G_array_red.npz')
    g_array_red2 = G_array_red2['data']   
    Ge_array_red2 = np.load('../2016-12-19_Andrea_BigNPs_5DiffTemps/' + prefix +'Ge_array_red.npz')
...
try:
    G_array_blue2 = np.load('../2016-12-19_Andrea_BigNPs_5DiffTemps/' + prefix +'G_array_blue.npz')
    g_array_blue2 = G_array_blue2['data']   
    Ge_array_blue2 = np.load('../2016-12-19_Andrea_BigNPs_5DiffTemps/' + prefix +'Ge_array_blue.npz')
    ge_array_blue2 = Ge_array_blue2['data']  
except:
    pass

Chiresult_red2 = np.load('../2016-12-19_Andrea_BigNPs_5DiffTemps/' +prefix +'Chiresult_red.npz')
chiresult_red2 = Chiresult_red2['data'] 
Chiresult_blue2 = np.load('../2016-12-19_Andrea_BigNPs_5DiffTemps/' +prefix +'Chiresult_blue.npz')
...
try:
    G_array_red3 = np.load('../2017-01-13_Andrea_NPs_CoolingDown_Controllably/' + prefix +'G_array_red.npz')
    g_array_red3 = G_array_red3['data']   
    Ge_array_red3 = np.load('../2017-01-13_Andrea_NPs_CoolingDown_Controllably/' + prefix +'Ge_array_red.npz')
...
try:
    G_array_blue3 = np.load('../2017-01-13_Andrea_NPs_CoolingDown_Controllably/' + prefix +'G_array_blue.npz')
    g_array_blue3 = G_array_blue3['data']   
    Ge_array_blue3 = np.load('../2017-01-13_Andrea_NPs_CoolingDown_Controllably/' + prefix +'Ge_array_blue.npz')
    ge_array_blue3 = Ge_array_blue3['data'] 
except:
    pass

Chiresult_red3 = np.load('../2017-01-13_Andrea_NPs_CoolingDown_Controllably/' +prefix +'Chiresult_red.npz')
chiresult_red3 = Chiresult_red3['data'] 
Chiresult_blue3 = np.load('../2017-01-13_Andrea_NPs_CoolingDown_Controllably/' +prefix +'Chiresult_blue.npz')
...
for index in np.arange(0,Multiplication_factor.shape[0]):
    ...
    legend1 = ax3.legend([label1,label2], loc='upper center')
    ...
    ax2.errorbar(x_vec, e_array_red/b_array_red*Multiplication_factor[index,0],  fmt='ro',markersize=10,ls='-')
    ax2.errorbar(x_vec, e_array_blue/b_array_blue*Multiplication_factor[index,0], fmt='go', markersize=10,ls='-')
    ax2.errorbar(x_vec2, e_array_red2/b_array_red2*Multiplication_factor[index,1],  fmt='r^',markersize=10,ls='dotted')
    ax2.errorbar(x_vec2, e_array_blue2/b_array_blue2*Multiplication_factor[index,1], fmt='g^', markersize=10,ls='dotted')
    ax2.errorbar(x_vec3, e_array_red3/b_array_red3*Multiplication_factor[index,2],  fmt='rs',markersize=10,ls='--')
    ax2.errorbar(x_vec3, e_array_blue3/b_array_blue3*Multiplication_factor[index,2], fmt='gs', markersize=10,ls='--')
    
    ax1.errorbar(x_vec, (e_array_red/b_array_red)/ (e_array_red[RTindex[0]]/b_array_red[RTindex[0]])*Multiplication_factor[index,0],  fmt='ro',markersize=10,ls='-')
    ax1.errorbar(x_vec, (e_array_blue/b_array_blue)/(e_array_blue[RTindex[0]]/b_array_blue[RTindex[0]])*Multiplication_factor[index,0], fmt='go', markersize=10,ls='-')
    ax1.errorbar(x_vec2, (e_array_red2/b_array_red2)/(e_array_red2[RTindex[1]]/b_array_red2[RTindex[1]])*Multiplication_factor[index,1],  fmt='r^',markersize=10,ls='dotted')
    ax1.errorbar(x_vec2, (e_array_blue2/b_array_blue2)/ (e_array_blue2[RTindex[1]]/b_array_blue2[RTindex[1]])*Multiplication_factor[index,1], fmt='g^', markersize=10,ls='dotted')
    ax1.errorbar(x_vec3, (e_array_red3/b_array_red3)/ (e_array_red3[RTindex[2]]/b_array_red3[RTindex[2]])*Multiplication_factor[index,2],  fmt='rs',markersize=10,ls='--')
    ax1.errorbar(x_vec3, (e_array_blue3/b_array_blue3)/(e_array_blue3[RTindex[2]]/b_array_blue3[RTindex[2]])*Multiplication_factor[index,2], fmt='gs', markersize=10,ls='--')
    ...
    try:    
        ax4.errorbar(x_vec, e_array_red/g_array_red*Multiplication_factor[index,0],  fmt='ro',markersize=10,ls='-')
        ax4.errorbar(x_vec, e_array_blue/g_array_blue*Multiplication_factor[index,0], fmt='go', markersize=10,ls='-')
        ax4.errorbar(x_vec2, e_array_red2/g_array_red2*Multiplication_factor[index,1],  fmt='r^',markersize=10,ls='dotted')
        ax4.errorbar(x_vec2, e_array_blue2/g_array_blue2*Multiplication_factor[index,1], fmt='g^', markersize=10,ls='dotted')
        ax4.errorbar(x_vec3, e_array_red3/g_array_red3*Multiplication_factor[index,2],  fmt='rs',markersize=10,ls='--')
        ax4.errorbar(x_vec3, e_array_blue3/g_array_blue3*Multiplication_factor[index,2], fmt='gs', markersize=10,ls='--')
        
        ax3.errorbar(x_vec, (e_array_red/g_array_red)/ (e_array_red[RTindex[0]]/g_array_red[RTindex[0]])*Multiplication_factor[index,0],  fmt='ro',markersize=10,ls='-')
        ax3.errorbar(x_vec, (e_array_blue/g_array_blue)/(e_array_blue[RTindex[0]]/g_array_blue[RTindex[0]])*Multiplication_factor[index,0], fmt='go', markersize=10,ls='-')
        ax3.errorbar(x_vec2, (e_array_red2/g_array_red2)/(e_array_red2[RTindex[1]]/g_array_red2[RTindex[1]])*Multiplication_factor[index,1],  fmt='r^',markersize=10,ls='dotted')
        ax3.errorbar(x_vec2, (e_array_blue2/g_array_blue2)/ (e_array_blue2[RTindex[1]]/g_array_blue2[RTindex[1]])*Multiplication_factor[index,1], fmt='g^', markersize=10,ls='dotted')
        ax3.errorbar(x_vec3, (e_array_red3/g_array_red3)/ (e_array_red3[RTindex[2]]/g_array_red3[RTindex[2]])*Multiplication_factor[index,2],  fmt='rs',markersize=10,ls='--')
        ax3.errorbar(x_vec3, (e_array_blue3/g_array_blue3)/(e_array_blue3[RTindex[2]]/g_array_blue3[RTindex[2]])*Multiplication_factor[index,2], fmt='gs', markersize=10,ls='--')
    except:
        pass
    ...
    try:
        ax2.errorbar(x_vec, b_array_red/g_array_red*Multiplication_factor[index,0],  fmt='ro',markersize=10,ls='-')
        ax2.errorbar(x_vec, b_array_blue/g_array_blue*Multiplication_factor[index,0], fmt='go', markersize=10,ls='-')
        ax2.errorbar(x_vec2, b_array_red2/g_array_red2*Multiplication_factor[index,1],  fmt='r^',markersize=10,ls='dotted')
        ax2.errorbar(x_vec2, b_array_blue2/g_array_blue2*Multiplication_factor[index,1], fmt='g^', markersize=10,ls='dotted')
        ax2.errorbar(x_vec3, b_array_red3/g_array_red3*Multiplication_factor[index,2],  fmt='rs',markersize=10,ls='--')
        ax2.errorbar(x_vec3, b_array_blue3/g_array_blue3*Multiplication_factor[index,2], fmt='gs', markersize=10,ls='--')
        
        ax1.errorbar(x_vec, (b_array_red/g_array_red)/ (b_array_red[RTindex[0]]/g_array_red[RTindex[0]])*Multiplication_factor[index,0],  fmt='ro',markersize=10,ls='-')
        ax1.errorbar(x_vec, (b_array_blue/g_array_blue)/(b_array_blue[RTindex[0]]/g_array_blue[RTindex[0]])*Multiplication_factor[index,0], fmt='go', markersize=10,ls='-')
        ax1.errorbar(x_vec2, (b_array_red2/g_array_red2)/(b_array_red2[RTindex[1]]/g_array_red2[RTindex[1]])*Multiplication_factor[index,1],  fmt='r^',markersize=10,ls='dotted')
        ax1.errorbar(x_vec2, (b_array_blue2/g_array_blue2)/ (b_array_blue2[RTindex[1]]/g_array_blue2[RTindex[1]])*Multiplication_factor[index,1], fmt='g^', markersize=10,ls='dotted')
        ax1.errorbar(x_vec3, (b_array_red3/g_array_red3)/ (b_array_red3[RTindex[2]]/g_array_red3[RTindex[2]])*Multiplication_factor[index,2],  fmt='rs',markersize=10,ls='--')
        ax1.errorbar(x_vec3, (b_array_blue3/g_array_blue3)/(b_array_blue3[RTindex[2]]/g_array_blue3[RTindex[2]])*Multiplication_factor[index,2], fmt='gs', markersize=10,ls='--')
    except:
        pass
    ...
    ax4.errorbar(x_vec, e_array_red/e_array_blue*Multiplication_factor[index,0],  fmt='ko',markersize=10,ls='-')
    ax4.errorbar(x_vec, b_array_red/b_array_blue*Multiplication_factor[index,0], fmt='ko', markersize=7,ls='-')
    
    ax4.errorbar(x_vec2, e_array_red2/e_array_blue2*Multiplication_factor[index,1],  fmt='k^',markersize=10,ls='dotted')
    ax4.errorbar(x_vec2, b_array_red2/b_array_blue2*Multiplication_factor[index,1], fmt='k^', markersize=7,ls='dotted')
    
    ax4.errorbar(x_vec3, e_array_red3/e_array_blue3*Multiplication_factor[index,2],  fmt='ks',markersize=10,ls='--')
    ax4.errorbar(x_vec3, b_array_red3/b_array_blue3*Multiplication_factor[index,2], fmt='ks', markersize=7,ls='--')
    
    ax3.errorbar(x_vec, (e_array_red/e_array_blue)/(e_array_red[RTindex[0]]/e_array_blue[RTindex[0]])*Multiplication_factor[index,0],  fmt='ko',markersize=10,ls='-')
    ax3.errorbar(x_vec, (b_array_red/b_array_blue)/(b_array_red[RTindex[0]]/b_array_blue[RTindex[0]])*Multiplication_factor[index,0], fmt='ko', markersize=7,ls='-')
    
    ax3.errorbar(x_vec2, (e_array_red2/e_array_blue2)/(e_array_red2[RTindex[1]]/e_array_blue2[RTindex[1]])*Multiplication_factor[index,1],  fmt='k^',markersize=10,ls='dotted')
    ax3.errorbar(x_vec2, (b_array_red2/b_array_blue2)/(b_array_red2[RTindex[1]]/b_array_blue2[RTindex[1]])*Multiplication_factor[index,1], fmt='k^', markersize=7,ls='dotted')
    
    ax3.errorbar(x_vec3, (e_array_red3/e_array_blue3)/(e_array_red3[RTindex[2]]/e_array_blue3[RTindex[2]])*Multiplication_factor[index,2],  fmt='ks',markersize=10,ls='--')
    ax3.errorbar(x_vec3, (b_array_red3/b_array_blue3)/(b_array_red3[RTindex[2]]/b_array_blue3[RTindex[2]])*Multiplication_factor[index,2], fmt='ks', markersize=7,ls='--')
    
    try:
        ax4.errorbar(x_vec, g_array_red/g_array_blue*Multiplication_factor[index,0], fmt='ko', markersize=4,ls='-')
        ax4.errorbar(x_vec2, g_array_red2/g_array_blue2*Multiplication_factor[index,1], fmt='k^', markersize=4,ls='dotted')
        ax4.errorbar(x_vec3, g_array_red3/g_array_blue3*Multiplication_factor[index,2], fmt='ks', markersize=4,ls='--')
        ax3.errorbar(x_vec, (g_array_red/g_array_blue)/(g_array_red[RTindex[0]]/g_array_blue[RTindex[0]])*Multiplication_factor[index,0], fmt='ko', markersize=4,ls='-')
        ax3.errorbar(x_vec2, (g_array_red2/g_array_blue2)/(g_array_red2[RTindex[1]]/g_array_blue2[RTindex[1]])*Multiplication_factor[index,1], fmt='k^', markersize=4,ls='dotted')
        ax3.errorbar(x_vec3, (g_array_red3/g_array_blue3)/(g_array_red3[RTindex[2]]/g_array_blue3[RTindex[2]])*Multiplication_factor[index,2], fmt='ks', markersize=4,ls='--')
    except:
        pass
    ...
    ax2.errorbar(x_vec, (red_int_array/blue_int_array)*Multiplication_factor[index,0], fmt='ko',markersize=10,ls='-')
    ax2.errorbar(x_vec2, (red_int_array2/blue_int_array2)*Multiplication_factor[index,1], fmt='k^',markersize=10,ls='dotted')
    ax2.errorbar(x_vec3, (red_int_array3/blue_int_array3)*Multiplication_factor[index,2], fmt='ks',markersize=10,ls='--')
    
    ax1.errorbar(x_vec, (red_int_array/blue_int_array)/(red_int_array[RTindex[0]]/blue_int_array[RTindex[0]])*Multiplication_factor[index,0], fmt='ko',markersize=10,ls='-')
    ax1.errorbar(x_vec2, (red_int_array2/blue_int_array2)/(red_int_array2[RTindex[1]]/blue_int_array2[RTindex[1]])*Multiplication_factor[index,1], fmt='k^',markersize=10,ls='dotted')
    ax1.errorbar(x_vec3, (red_int_array3/blue_int_array3)/(red_int_array3[RTindex[2]]/blue_int_array3[RTindex[2]])*Multiplication_factor[index,2], fmt='ks',markersize=10,ls='--')
    ...
    ax4.errorbar(x_vec, (red_int_array-blue_int_array)/(red_int_array+blue_int_array)*Multiplication_factor[index,0], fmt='ko',markersize=10,ls='-')
    ax4.errorbar(x_vec2, (red_int_array2-blue_int_array2)/(red_int_array2+blue_int_array2)*Multiplication_factor[index,1], fmt='k^',markersize=10,ls='dotted')
    ax4.errorbar(x_vec3,(red_int_array3-blue_int_array3)/(red_int_array3+blue_int_array3)*Multiplication_factor[index,2], fmt='ks',markersize=10,ls='--')
    
    ax3.errorbar(x_vec, ((red_int_array-blue_int_array)/(red_int_array+blue_int_array))/((red_int_array[RTindex[0]]-blue_int_array[RTindex[0]])/(red_int_array[RTindex[0]]+blue_int_array[RTindex[0]]))*Multiplication_factor[index,0], fmt='ko',markersize=10,ls='-')
    ax3.errorbar(x_vec2, ((red_int_array2-blue_int_array2)/(red_int_array2+blue_int_array2))/ ((red_int_array2[RTindex[1]]-blue_int_array2[RTindex[1]])/(red_int_array2[RTindex[1]]+blue_int_array2[RTindex[1]]))*Multiplication_factor[index,1], fmt='k^',markersize=10,ls='dotted')
    ax3.errorbar(x_vec3,((red_int_array3-blue_int_array3)/(red_int_array3+blue_int_array3))/((red_int_array3[RTindex[2]]-blue_int_array3[RTindex[2]])/(red_int_array3[RTindex[2]]+blue_int_array3[RTindex[2]]))*Multiplication_factor[index,2], fmt='ks',markersize=10,ls='--')
