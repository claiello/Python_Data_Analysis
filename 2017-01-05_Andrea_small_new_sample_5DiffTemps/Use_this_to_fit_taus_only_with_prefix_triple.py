    ...
    if (prefix == 'fixCprevtautriple') or (prefix=='varCprevtautriple'):
        ...
        if index == 1:
            ...
            if index == 5:
                ...
                init_guess[6] = np.average(g_array_red[2]+g_array_red[1]+g_array_red[4])
                ...
                init_guessb[6] = np.average(g_array_blue[2]+g_array_blue[1]+g_array_blue[4])
