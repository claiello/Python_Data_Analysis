...
#for index in listofindex:
    ...
    ax1.set_title('Electron topography',fontsize=fsizepl)
    ...
    im = plt.imshow(se['data'],cmap=cm.Greys_r) #or 'OrRd'
...
#    ee_array_blue[index] = ee2  
    ...
    multipage_longer('ZZZZZZZGreenSEallSingle-'+ let[index] + '.pdf',dpi=80)
