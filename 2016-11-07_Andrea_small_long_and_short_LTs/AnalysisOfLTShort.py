...
#10mus: 400ns move/1.6mus excite/8 mus decay lt, 40ns time bins
...
nametr = ['2016-11-07-1005_ImageSequence_AndreaSmall_157.960kX_10.000kV_30mu_4',
'2016-11-07-1010_ImageSequence_AndreaSmall_157.960kX_10.000kV_30mu_6',
'2016-11-07-1015_ImageSequence_AndreaSmall_157.960kX_10.000kV_30mu_8',
'2016-11-07-1036_ImageSequence_AndreaSmall_260.188kX_10.000kV_30mu_13']

namese = ['2016-11-07-1006_ImageSequence_AndreaSmall_157.960kX_10.000kV_30mu_5',
          '2016-11-07-1011_ImageSequence_AndreaSmall_157.960kX_10.000kV_30mu_7',
          '2016-11-07-1016_ImageSequence_AndreaSmall_157.960kX_10.000kV_30mu_9',
          '2016-11-07-1037_ImageSequence_AndreaSmall_260.188kX_10.000kV_30mu_14']
...
for index in listofindex:
    ...
    titulo = 'Region ' + let[index] + '(10kV, 30$\mu$m aperture, 2$\mu$s time bins, ' + str(Ps)+ 'nm pixels, blue/red: $</>$ 593nm)'
...
#        hlp[~np.isnan(hlp)] = 1.0
    ...
    ax1.axvspan(0.4,2.0, alpha=0.25, color='yellow')
    unit = 'kHz'
