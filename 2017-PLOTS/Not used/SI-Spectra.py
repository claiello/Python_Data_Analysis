...
specRT = genfromtxt('RTNEW.txt', delimiter='')
spec30 = genfromtxt('30NEW.txt', delimiter='')
spec40 = genfromtxt('40NEW.txt', delimiter='')
...
vectemp = [24, 30.6, 40.55, 50.15, 61.4, 71.3] #[25,30,40,50,60,70]
vectempstd = [0, 0.5, 0.55, 0.55, 1.4, 1.3]
#Real temps:
#temp start end
#RT 24 20
#30 30.1 31.1
#40 40.0 41.1
#50 50.1 up and down to 50.7 and 49.6 end 50.1
#60 60.0 62.8
#70 70.0 72.6
...
plt.tight_layout()
multipage_longer_desired_aspect_ratio('SI-spectra.pdf',1600,1200,dpi=80,)
