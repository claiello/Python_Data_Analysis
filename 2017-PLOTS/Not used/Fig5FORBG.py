...
if True:
    ...
    Il_data3 = np.load('../2017-03-19_Andrea_NPs_NewTempData_ThemorcoupleOnSample+FilterNEW/Il_data.npz')
    xvec = Il_data3['data']  
    Il_data_std3 = np.load('../2017-03-19_Andrea_NPs_NewTempData_ThemorcoupleOnSample+FilterNEW/Il_data_std.npz')
    xvecstd = Il_data_std3['data']  
    
    Red_decay_array3 = np.load('../2017-03-19_Andrea_NPs_NewTempData_ThemorcoupleOnSample+FilterNEW/bgRed_decay_array.npz') 
    red = Red_decay_array3['data']
    Blue_decay_array3 = np.load('../2017-03-19_Andrea_NPs_NewTempData_ThemorcoupleOnSample+FilterNEW/bgBlue_decay_array.npz') 
    ...
    Notr[0,:] = 5.0*No_bg[0] * Nopointsbeamon
    Notr[1,:] = 5.0*No_bg[1] * Nopointsbeamon
    Notr[2,:] = 5.0*No_bg[2] * Nopointsbeamon
    Notr[3,:] = 5.0*No_bg[3] * Nopointsbeamon
    Notr[4,:] = 5.0*No_bg[4] * Nopointsbeamon
    Notr[5,:] = 5.0*No_bg[5] * Nopointsbeamon     
...
plt.tight_layout()
multipage_longer('Fig5BACKGROUND.pdf',dpi=80)
