...
nametr = ['2016-11-07-1151_ImageSequence_Steffan_125.228kX_10.000kV_30mu_3']

namese = ['2016-11-07-1152_ImageSequence_Steffan_125.228kX_10.000kV_30mu_4']
...
##files below exist 
b_array_red = np.zeros(1)
be_array_red = np.zeros(1)
e_array_red = np.zeros(1)
ee_array_red = np.zeros(1)
b_array_blue = np.zeros(1)
be_array_blue = np.zeros(1)
e_array_blue = np.zeros(1)
ee_array_blue = np.zeros(1)
blue_int_array = np.zeros(1)
red_int_array = np.zeros(1)
cumu_blue = np.zeros([1,1])
cumu_red = np.zeros([1,1])
il_data = np.zeros([1,1])

listofindex =np.arange(0,1) # #[0,1,2]  [5] 
#index = 2
#if index is 0:
