...
#        hlp[~np.isnan(hlp)] = 1.0
    ...
    if True is False:
        ...
        initbin = 68-1#### ACHTUNG!!!!!! WAS ORIGINALLY!!!!!!!!!!!!!!!!!
        ### 700ns /40ns = 
...
#        datablue = datablue[initbin:,:,:]
    ...
    cinit = np.nanmean(datared_init*hlpd,axis=(0,1,2))
    
    
    init_guess = [np.average(datared[0,:,:]), 0.05, cinit, np.average(datared[medium_pt_offset:,:,:]), 0.5] #e init was 0.5
