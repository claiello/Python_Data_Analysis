...
Pixel_size = [2.5e-09, 3.4e-08, 2.0e-08]
Ps = [2.5, 34, 20] #pixel size in nm, the numbers above with round nm precision
No_experiments = [50,50,50]
                  
namese = ['2016-09-10-1656_ImageSequence__44.466kX_20.000kV_30mu_9',
'2016-09-10-1923_ImageSequence__3.322kX_20.000kV_30mu_15',
'2016-09-10-2008_ImageSequence__5.472kX_20.000kV_30mu_22']    

nametr = ['2016-09-10-1820_ImageSequence__44.466kX_20.000kV_30mu_2',
'2016-09-10-1954_ImageSequence__3.322kX_20.000kV_30mu_16',
'2016-09-10-2040_ImageSequence__5.472kX_20.000kV_30mu_23']      

description = [
               'Bella 10nm NaYF$_4$ Er 2$\%$ CS on SiO$_2, \n with OA$', 'Bella 10nm NaYF$_4$ Er 2$\%$ CS on SiO$_2$, \n no OA','Bella 10nm NaYF$_4$ Er 2$\%$ CS on SiO$_2$, \n no OA']    
