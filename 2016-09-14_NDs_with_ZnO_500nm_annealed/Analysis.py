...
name = ['2016-09-14-0917_ImageSequence_10minannealing+nds_2.313kX_4.000kV_30mu_5',
'2016-09-14-0953_ImageSequence_10minannealing+nds+2kv_0.336kX_2.500kV_30mu_14',
'2016-09-14-0953_ImageSequence_10minannealing+nds+2kv_0.336kX_2.500kV_30mu_15',
'2016-09-14-0955_ImageSequence_10minannealing+nds+2kv_0.336kX_2.500kV_30mu_16',
'2016-09-14-1037_ImageSequence_10minannealing+nds+2kv_38.854kX_2.500kV_30mu_35',
'2016-09-14-1110_ImageSequence_10minannealing+nds+2kv_38.850kX_2.000kV_30mu_39']
Pixel_size = [4.2e-08, 3.3e-07, 3.3e-07, 3.3e-07, 2.9e-09, 2.9e-09] #as given by accompanying text file
Ps = [42,330,330,330,2.9,2.9]
lag = [1000,1000,1000,1000,5000,5000] #in microsec
frames = [20, 5,1,1,20,20] 
obs = ['Region I', 'Region II','Region III',  'Region IV', 'Region V', 'Region VI']
kv = ['4', '2.5', '2.5', '2.5', '2.5', '2']
...
#plt.close("all")
title =  'NDs + ZnO:Ga annealed at $\sim$500nm + pmma (' + kv[index] + 'kV, 120 $\mu$m, ' + str(Ps[index]) + 'nm pixels, ' + str(lag[index]) + '$\mu$s lag per pixel, ' + str(frames[index]) + 'expts., SE registered), \n' + obs[index] 
scinti_channel = '$<$ 509nm'
sample_channel = '$>$ 509nm'
...
plot_2_channels_divide(se_dset_cut,blue_dset_cut, red_dset_cut, Pixel_size[index], title, scinti_channel, sample_channel, length_scalebar, scalebar_legend,unit)
