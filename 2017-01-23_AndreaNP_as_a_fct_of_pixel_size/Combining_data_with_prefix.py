...
prefix = pref0 + Cvaried + pref2 + pref3 + extrapref

backgdinit = 50
initbin = (150+50+3)-1

red_int_array = np.zeros(5)
blue_int_array = np.zeros(5)
for jj in np.arange(0,5):
    
    redd = np.load( let[jj] + 'RED1D.npz',mmap_mode='r') 
    blued = np.load(let[jj] + 'BLUE1D.npz',mmap_mode='r') 
    red_int_array[jj] = np.nanmean(redd['data'][backgdinit:initbin])
    blue_int_array[jj] = np.nanmean(blued['data'][backgdinit:initbin])
...
pixel_size = np.load(prefix +'Pixel_size.npz')
Pixel_size = pixel_size['data']

#MULT FACTORS CURRENTLY NOT DOING ANYTHING
Multiplication_factor =np.zeros((5,3))
Multiplication_factor[0,:] = [1,1,1]
Multiplication_factor[1,:] = Pixel_size[0]*Pixel_size[0]
Multiplication_factor[2,:] = 1.0/(Pixel_size[0]*Pixel_size[0])
Multiplication_factor[3,:] = Pixel_size[0]
Multiplication_factor[4,:] = 1.0/(Pixel_size[0])
description = ['no area norm.', r'$\times$ area', '$\div$ area', r'$\times$ length', '$\div$ length']

RTindex = [0,0,0] #largest/smallest/medium

for index in [0]: #np.arange(0,Multiplication_factor.shape[0]):
    ...
    se = np.load(let[0] +'SEchannel.npz',mmap_mode='r') 
...
#    ax3.add_artist(legend1)    
    ...
    ax0.set_xlabel('Pixel size (nm)',fontsize=fsizepl)
...
#    ax1.errorbar(x_vec3, (e_array_blue3/b_array_blue3)/(e_array_blue3[RTindex[2]]/b_array_blue3[RTindex[2]])*Multiplication_factor[index,2], fmt='gs', markersize=10,ls=None)
    ...
    label1 = my_fits.fit_with_plot_small(ax2, x_vec, e_array_red/b_array_red*Multiplication_factor[index,0], yerr = None, my_color = 'r', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
    label2 = my_fits.fit_with_plot_small(ax2, x_vec, e_array_blue/b_array_blue*Multiplication_factor[index,0], yerr = None, my_color = 'g', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
...
#    label6 = my_fits.fit_with_plot_small(ax2, x_vec3, e_array_blue3/b_array_blue3*Multiplication_factor[index,2], yerr = None, my_color = 'g', my_edgecolor=None, my_facecolor=None, my_linestyle = '--')
    ...
    legend1 = ax2.legend([label1,label2], loc=legendloc) #,label3,label4,label5,label6], loc=legendloc)
    ax2.add_artist(legend1)  
    
    label1 = my_fits.fit_with_plot_small(ax1, x_vec,(e_array_red/b_array_red)/ (e_array_red[RTindex[0]]/b_array_red[RTindex[0]])*Multiplication_factor[index,0] , yerr = None, my_color = 'r', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
    label2 = my_fits.fit_with_plot_small(ax1, x_vec,(e_array_blue/b_array_blue)/(e_array_blue[RTindex[0]]/b_array_blue[RTindex[0]])*Multiplication_factor[index,0] , yerr = None, my_color = 'g', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
...
#    
    legend1 = ax1.legend([label1,label2], loc=legendloc) #,label3,label4,label5,label6], loc=legendloc)
...
#        ax4.errorbar(x_vec3, e_array_blue3/g_array_blue3*Multiplication_factor[index,2], fmt='gs', markersize=10,ls=None)
        ...
        label1 = my_fits.fit_with_plot_small(ax4, x_vec, e_array_red/g_array_red*Multiplication_factor[index,0]  , yerr = None, my_color = 'r', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
        label2 = my_fits.fit_with_plot_small(ax4, x_vec, e_array_blue/g_array_blue*Multiplication_factor[index,0] , yerr = None, my_color = 'g', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
...
#        ax3.errorbar(x_vec3, (e_array_blue3/g_array_blue3)/(e_array_blue3[RTindex[2]]/g_array_blue3[RTindex[2]])*Multiplication_factor[index,2], fmt='gs', markersize=10,ls=None)
        ...
        label1 = my_fits.fit_with_plot_small(ax3, x_vec, (e_array_red/g_array_red)/ (e_array_red[RTindex[0]]/g_array_red[RTindex[0]])*Multiplication_factor[index,0]  , yerr = None, my_color = 'r', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
        label2 = my_fits.fit_with_plot_small(ax3, x_vec, (e_array_blue/g_array_blue)/(e_array_blue[RTindex[0]]/g_array_blue[RTindex[0]])*Multiplication_factor[index,0], yerr = None, my_color = 'g', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
...
#    
        legend1 = ax3.legend([label1,label2], loc=legendloc) #,label3,label4,label5,label6], loc=legendloc)
        ax3.add_artist(legend1) 
    except:
        pass
    ...
    ax3.set_xlabel('Pixel size (nm)',fontsize=fsizepl)
...
#        ax2.errorbar(x_vec3, b_array_blue3/g_array_blue3*Multiplication_factor[index,2], fmt='gs', markersize=10,ls=None)
        ...
        label1 = my_fits.fit_with_plot_small(ax2, x_vec, b_array_red/g_array_red*Multiplication_factor[index,0] , yerr = None, my_color = 'r', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
        label2 = my_fits.fit_with_plot_small(ax2, x_vec, b_array_blue/g_array_blue*Multiplication_factor[index,0] , yerr = None, my_color = 'g', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
...
#        
        label1 = my_fits.fit_with_plot_small(ax1, x_vec,  (b_array_red/g_array_red)/ (b_array_red[RTindex[0]]/g_array_red[RTindex[0]])*Multiplication_factor[index,0] , yerr = None, my_color = 'r', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
        label2 = my_fits.fit_with_plot_small(ax1, x_vec,  (b_array_blue/g_array_blue)/(b_array_blue[RTindex[0]]/g_array_blue[RTindex[0]])*Multiplication_factor[index,0] , yerr = None, my_color = 'g', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
...
#    ax4.errorbar(x_vec3, b_array_red3/b_array_blue3*Multiplication_factor[index,2], fmt='ks', markersize=7,ls=None)
    ...
    label1 = my_fits.fit_with_plot_small(ax4, x_vec, e_array_red/e_array_blue*Multiplication_factor[index,0]  , yerr = None, my_color = 'k', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
    label2 = my_fits.fit_with_plot_small(ax4, x_vec, b_array_red/b_array_blue*Multiplication_factor[index,0]  , yerr = None, my_color = 'k', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
...
#    ax3.errorbar(x_vec3, (b_array_red3/b_array_blue3)/(b_array_red3[RTindex[2]]/b_array_blue3[RTindex[2]])*Multiplication_factor[index,2], fmt='ks', markersize=7,ls=None)
    ...
    label10 = my_fits.fit_with_plot_small(ax3, x_vec, (e_array_red/e_array_blue)/(e_array_red[RTindex[0]]/e_array_blue[RTindex[0]])*Multiplication_factor[index,0] , yerr = None, my_color = 'k', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
    label20 = my_fits.fit_with_plot_small(ax3, x_vec, (b_array_red/b_array_blue)/(b_array_red[RTindex[0]]/b_array_blue[RTindex[0]])*Multiplication_factor[index,0]  , yerr = None, my_color = 'k', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
...
#        
        label7 = my_fits.fit_with_plot_small(ax4, x_vec,  g_array_red/g_array_blue*Multiplication_factor[index,0] , yerr = None, my_color = 'k', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
...
#        label9 = my_fits.fit_with_plot_small(ax4, x_vec3,     g_array_red3/g_array_blue3*Multiplication_factor[index,2]  , yerr = None, my_color = 'k', my_edgecolor=None, my_facecolor=None, my_linestyle = '--')
        label70 = my_fits.fit_with_plot_small(ax3, x_vec, (g_array_red/g_array_blue)/(g_array_red[RTindex[0]]/g_array_blue[RTindex[0]])*Multiplication_factor[index,0]   , yerr = None, my_color = 'k', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
...
#        
        ...
        legend1 = ax4.legend([label1,label2], loc=legendloc) #,label3,label4,label5,label6], loc=legendloc)
        ax4.add_artist(legend1) 
        legend1 = ax3.legend([label10,label20], loc=legendloc) #,label30,label40,label50,label60], loc=legendloc)
        ax3.add_artist(legend1) 
...
#    ax2.errorbar(x_vec3, (red_int_array3/blue_int_array3)*Multiplication_factor[index,2], fmt='ks',markersize=10,ls=None)
    ...
    label1 = my_fits.fit_with_plot_small(ax2, x_vec,  (red_int_array/blue_int_array)*Multiplication_factor[index,0]  , yerr = None, my_color = 'k', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
    ...
    legend1 = ax2.legend([label1,label2], loc=legendloc) #,label3], loc=legendloc)
    ax2.add_artist(legend1) 
   ...
   # ax1.errorbar(x_vec2, (red_int_array2/blue_int_array2)/(red_int_array2[RTindex[1]]/blue_int_array2[RTindex[1]])*Multiplication_factor[index,1], fmt='k^',markersize=10,ls=None)
    ...
    label1 = my_fits.fit_with_plot_small(ax1, x_vec, (red_int_array/blue_int_array)/(red_int_array[RTindex[0]]/blue_int_array[RTindex[0]])*Multiplication_factor[index,0]  , yerr = None, my_color = 'k', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
    ...
    legend1 = ax1.legend([label1,label2], loc=legendloc) #,label3], loc=legendloc)
    ax1.add_artist(legend1) 
    ...
    label1 = my_fits.fit_with_plot_small(ax4, x_vec,  (red_int_array-blue_int_array)/(red_int_array+blue_int_array)*Multiplication_factor[index,0]  , yerr = None, my_color = 'k', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
    ...
    legend1 = ax4.legend([label1,label2], loc=legendloc) #,label3], loc=legendloc)
    ax4.add_artist(legend1) 
   ...
   # ax3.errorbar(x_vec3,((red_int_array3-blue_int_array3)/(red_int_array3+blue_int_array3))/((red_int_array3[RTindex[2]]-blue_int_array3[RTindex[2]])/(red_int_array3[RTindex[2]]+blue_int_array3[RTindex[2]]))*Multiplication_factor[index,2], fmt='ks',markersize=10,ls=None)
    ...
    label1 = my_fits.fit_with_plot_small(ax3, x_vec, ((red_int_array-blue_int_array)/(red_int_array+blue_int_array))/((red_int_array[RTindex[0]]-blue_int_array[RTindex[0]])/(red_int_array[RTindex[0]]+blue_int_array[RTindex[0]]))*Multiplication_factor[index,0]   , yerr = None, my_color = 'k', my_edgecolor=None, my_facecolor=None, my_linestyle = '-')
    ...
    legend1 = ax3.legend([label1,label2], loc=legendloc) #,label3], loc=legendloc)
    ax3.add_artist(legend1) 
    ...
    prefix = 'varC_' + pref2 + pref3 + pref4 + extrapref
