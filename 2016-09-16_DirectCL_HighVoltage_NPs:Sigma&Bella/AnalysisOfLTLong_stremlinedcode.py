...
nametr = ['','','','']
Pixel_size = [0, 0, 0,0,24.7, 0, 0, 0,11.1, 0, 11.7, 0] #nm
...
description = ['Sigma-Aldrich 150nm LiYF$_4$ on SiO$_2$','Sigma-Aldrich 150nm LiYF$_4$ on SiO$_2$','Sigma-Aldrich 150nm LiYF$_4$ on SiO$_2$',
               ...
               'Bella 10nm NaYF$_4$ Er 2$\%$ C on Si']     # (20kV, 30$\mu$m, ' + str(Ps[index]) + 'nm pixels, ' + str(No_experiments[index]) + 'expts., InLens registered)'] #, \n' #+ obs[index] ']    
...
for index in listofindex:
    ...
    titulo = description[index] + ' (10kV, 30$\mu$m aperture, 100ns time bins, ' + str(Ps)+ 'nm pixels, red/blue: $>/<$ 593nm)'
    ...
    ax1.axvspan(0.2+0.3,0.2+2.0+0.3, alpha=0.25, color='yellow')
    unit = 'kHz'
    ...
    if True is False:
        ...
        initbin = (24)-1 #init bin for decay
        backgdinit = 5
        ### 700ns /40ns = 7. ....
