###Using Stefan's usual NPs - dot-rod-tip high concentration
# Data taken: blue channel is using RED PMT and 650nm dichroic: blue is <650nm
#red channel is using IR PMT and 600LP: red is > 700nm
import os
import sys
...
nametr = ['2016-11-08-1914_ImageSequence_StefanRealHeater_45.849kX_20.000kV_30mu_3',
          '2016-11-08-1931_ImageSequence_StefanRealHeater_45.849kX_20.000kV_30mu_6',
          '2016-11-08-1948_ImageSequence_StefanRealHeater_45.849kX_20.000kV_30mu_9',
          '2016-11-08-2006_ImageSequence_StefanRealHeater_45.849kX_20.000kV_30mu_12']
...
#for index in listofindex:
    ...
    hlp = segmm['bright']
    hlp[~np.isnan(hlp)] = 1.0  ####HACK TO TAKE ALL INTO ACCOUNT???????? #was 0.0
