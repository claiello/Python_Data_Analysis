...
nametr = ['2016-11-08-1917_ImageSequence_StefanRealHeater_45.849kX_20.000kV_30mu_4',
          '2016-11-08-1934_ImageSequence_StefanRealHeater_45.849kX_20.000kV_30mu_7',
          '2016-11-08-1951_ImageSequence_StefanRealHeater_45.849kX_20.000kV_30mu_10',
          '2016-11-08-2009_ImageSequence_StefanRealHeater_45.849kX_20.000kV_30mu_13']

namese = ['2016-11-08-1918_ImageSequence_StefanRealHeater_45.849kX_20.000kV_30mu_5',
          '2016-11-08-1935_ImageSequence_StefanRealHeater_45.849kX_20.000kV_30mu_8',
          '2016-11-08-1952_ImageSequence_StefanRealHeater_45.849kX_20.000kV_30mu_11',
          '2016-11-08-2010_ImageSequence_StefanRealHeater_45.849kX_20.000kV_30mu_14']

description = ['Stefan NaYF4:Er'] # (20kV, 30$\mu$m, ' + str(Ps[index]) + 'nm pixels, ' + str(No_experiments[index]) + 'expts., InLens registered)'] #, \n' #+ obs[index] ']    
...
#for index in listofindex:
    ...
    titulo = 'Region ' + let[index] + ', ' + str("{0:.6f}".format(np.average(il['data'])*1000.0)) + 'mV (10kV, 30$\mu$m aperture, 2$\mu$s time bins, ' + str(Ps)+ 'nm pixels, blue/red: $</>$ 593nm)'
...
#        hlp[~np.isnan(hlp)] = 1.0
    ...
    plt.plot(np.arange(0,250)*Time_bin/1e3,np.nanmean(red['data']*hlp,axis = (0,2,3)),c='r',label='Red photons ($>$ 593nm)',lw=3) #in mus, in MHz
    plt.plot(np.arange(0,250)*Time_bin/1e3,np.nanmean(blue['data']*hlp,axis = (0,2,3)),c='b',label='Blue photons ($<$ 593nm)',lw=3) #in mus, in MHz
...
#    
    ...
    if index == 0: #needs to be reworked out
       #pass
       init_guess = [np.nanmean(hlp_red[0,:,:]), 0.5, np.nanmean(hlp_red[last_pt_offset,:,:])+0.1, np.nanmean(hlp_red[10:50,:,:]), 10.0 ] #RED
       init_guess2 = [np.nanmean(hlp_blue[0,:,:]), 0.5,np.nanmean(hlp_blue[last_pt_offset,:,:])+0.1, np.nanmean(hlp_blue[10:50,:,:]), 10.0 ] #BLUE
