...
nametr = ['2016-12-19-1350_ImageSequenceDifferentShapes_commercialNP_100.000kX_10.000kV_30mu_20',
          '2016-12-19-1403_ImageSequenceDifferentShapes_commercialNP_100.000kX_10.000kV_30mu_21',
          '2016-12-19-1419_ImageSequenceDifferentShapes_commercialNP_100.000kX_10.000kV_30mu_22',
          '2016-12-19-1445_ImageSequenceDifferentShapes_commercialNP_100.000kX_10.000kV_30mu_23',
          '2016-12-19-1501_ImageSequenceDifferentShapes_commercialNP_100.000kX_10.000kV_30mu_24',
          '2016-12-19-1524_ImageSequenceDifferentShapes_commercialNP_100.000kX_10.000kV_30mu_25',
          '2016-12-19-1541_ImageSequenceDifferentShapes_commercialNP_100.000kX_10.000kV_30mu_26']
...
let = ['V0lisajous','V0','V0pt25' ,'V0pt5', 'V0pt75','V1', 'V1refocus']
...
##files below exist 
b_array_red = np.zeros(7)
be_array_red = np.zeros(7)
e_array_red = np.zeros(7)
ee_array_red = np.zeros(7)
b_array_blue = np.zeros(7)
be_array_blue = np.zeros(7)
e_array_blue = np.zeros(7)
ee_array_blue = np.zeros(7)
blue_int_array = np.zeros(7)
red_int_array = np.zeros(7)
cumu_blue = np.zeros([7,1])
cumu_red = np.zeros([7,1])
il_data = np.zeros([7,1])

listofindex =np.arange(0,7) # #[0,1,2]  [5] 
#index = 0
#if index is 1:
