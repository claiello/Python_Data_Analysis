##I messed up with this file!!!! I changed the name of the 2 long files
#Sorry, future me.
...
#    
#        gc.collect()
#        gmmse_blue1_darkse_dset_for_4D, gmmse_blue1_brightse_dset_forax1 = plt.subplot2grid((2,4), (0, 2), colspan=1)
...
##    ax1.yaxis.set_ticks_position('left')_4D, blah, blup, darkse_pct2, brightse_pct2 =  gmmone_tr_in_masked_channel(se1_dset_cut, blue1_dset_cut_all, imagemasked_is_4D=True) 
#       # del blah, blup, darkse_pct2, brightse_pct2 #delete all SE masks 
#       # gc.collect()
...
#for index in listofindex:
    ...
    file1    = h5py.File('2016-11-07-0958_ImageSequence_AndreaSmall_157.960kX_10.000kV_30mu_3' + '.hdf5', 'r')  
    ...
    hlp = segmm['bright']
    hlp[~np.isnan(hlp)] = 1.0 #hack: was 0.0 but I want to use all pixels
