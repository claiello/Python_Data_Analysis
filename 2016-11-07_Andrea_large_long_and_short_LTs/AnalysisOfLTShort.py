...
nametr = ['2016-11-07-1058_ImageSequence_AndreaSmall_203.433kX_10.000kV_30mu_17',
'2016-11-07-1115_ImageSequence_AndreaSmall_79.805kX_10.000kV_30mu_21']

namese = ['2016-11-07-1059_ImageSequence_AndreaSmall_203.433kX_10.000kV_30mu_18',
          '2016-11-07-1116_ImageSequence_AndreaSmall_79.805kX_10.000kV_30mu_22']
...
for index in listofindex:
    ...
    hlp = segmm['bright']
    hlp[~np.isnan(hlp)] = 1.0 #using all pixels as signal; used to be 0.0
...
#    
    ...
    if index == 0: #needs to be reworked out
       #pass
       init_guess = [np.nanmean(hlp_red[0,:,:])+0.1, 1.0, np.nanmean(hlp_red[last_pt_offset,:,:]), np.nanmean(hlp_red[10:50,:,:]), 10.0 ] #RED
