...
#                arrowprops=dict(facecolor='black', shrink=0.05))              
    ...
    blue = np.load('Blue_decay_arrayPixel.npz',mmap_mode='r')     
    red = np.load('Red_decay_arrayPixel.npz',mmap_mode='r')
    bgblue = np.load('bgBlue_decay_arrayPixel.npz',mmap_mode='r')     
    bgred = np.load('bgRed_decay_arrayPixel.npz',mmap_mode='r') 
    ...
    plt.tight_layout() 
    #plt.show()  
    multipage_longer('IsTauSingleSINGLE750kX.pdf',dpi=80)
    
    del red, blue, bgred, bgblue
    
    blue = np.load('Blue_int_arrayPixel.npz',mmap_mode='r')     
    red = np.load('Red_int_arrayPixel.npz',mmap_mode='r')
    bgblue = np.load('bgBlue_int_arrayPixel.npz',mmap_mode='r')     
    bgred = np.load('bgRed_int_arrayPixel.npz',mmap_mode='r') 
    ...
    plt.plot([0],[2.32637486],marker='o',color='r',markersize=16)#[ 2.32637486]
    plt.plot([1],[0.47494326],marker='o',color='g',markersize=16)# 0.47494326
    plt.plot([0],[2.04040113],marker='o',color='DarkRed',markersize=16)#2.04040113
    plt.plot([1],[0.33649939],marker='o',color='#003100',markersize=16)# 0.33649939
