#==============================================================================
#10kX, 3 frames, 8e-6: 2mus move, 4mus excite, 2mus decay, 300x300pixels
#==============================================================================
...
#    se1_dset_reg, blue1_dset_reg, blue1_dset_reg_all = reg_time_resolved_images_to_se(se1_dset2, blue1_dset)
    ...
    #print(np.sum(np.isnan(red1_dset_reg)))2017-03-29-1539_ImageSequence__10.000kX_2.000kV_30mu_14
