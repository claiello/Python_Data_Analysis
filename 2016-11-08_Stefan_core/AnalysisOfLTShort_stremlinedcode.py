...
for index in listofindex:
    ...
    titulo = description + ' (20kV, 30$\mu$m aperture, 40ns time bins, ' + str(Ps)+ 'nm pixels, red/blue: $>$715nm/$<$650nm)'
    ...
    ax1.axvspan(0.4+0.3,0.4+1.6+0.3, alpha=0.25, color='yellow')
    unit = 'kHz'
    ...
    if True is False:
        ...
        initbin = (10+40+7+2)-1 #init bin for decay
        backgdinit = 10
        ### 700ns /40ns = 7. ....
