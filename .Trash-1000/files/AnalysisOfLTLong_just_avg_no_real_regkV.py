...
# standard: 300pixels
#kv scan
#checked: all at 30mum aperture, all at 379pA as per optiprobe
#max kv is 16.8kV since this was the largest kV I could get without it changing to a larger aperture
#==============================================================================
...
temp_std = [0.1, 0.3, 0.25, 0.95, 0.35, 0.7]
